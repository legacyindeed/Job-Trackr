...
export async function POST(request: Request) {
    ...
    try {
        ...
        const { title, company, location, salary, url, status = 'Applied', jobType, description } = job;
        ...
        await sql`
            ...
            VALUES (${title}, ${company}, ${location ?? null}, ${salary ?? null}, ${url}, ${status}, ${jobType ?? null}, ${description ?? null}, ${userId}, NOW())
